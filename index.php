...
<body id="switcher-body">
   ...
   <div class="row">
    ...
    <div
     ...
     <div class="client-info">
      <ul class="list-unstyled mb-0 d-flex">
       <li><a href="tel:+61383766284"><img src="assets/images/phone-icon.png" alt="phone-icon"> +61
         3 8376
         6284</a></li>
       <li><a href="mailto:Info@letsclean.com"><img src="assets/images/email-icon.png"
          alt="email-icon">
  ...
  <div class="wrapper">
   <nav class="navbar navbar-expand-lg navbar-dark px-0">
    ...
    <div class="collapse navbar-collapse justify-content-between" id="navbarToggle">
     <ul class="navbar-nav">
      <li class="nav-item">
       <a class="nav-link active p-0" href="index-2.html">HOME</a>
      </li>
      <li class="nav-item">
    ...
    <div class="row">
     <div class="col-lg-7">
      <div class="banner-title position-relative">
       <h1 class="text-white" data-aos="fade-up" data-aos-duration="600">Affordable Cleaning
        Services For Everyone.</h1>
       <p data-aos="fade-up" data-aos-duration="600">Lorem ipsum dolor sit amet, consectetur
        adipisicing elit, sed do eiusmod tempor incididunt ut
        labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ulla
        mco laboris nisi ut aliquip ex ea commodo consequat.</p>
    ...
    <div class="generic-box-img position-relative circle-box" data-aos="fade-up" data-aos-duration="600">
     <div class="generic-box-img1 position-relative">
      <figure class="mb-0 position-relative">
       <img src="assets/images/clean-img.png" alt="clean-img">
      </figure>
     </div>
     <figure class="mb-0 generic-box-img2">
      <img src="assets/images/clean-small-img.png" alt="clean-small-img">
     </figure>
    </div>
    <div class="generic-box-content position-relative">
     <h2 data-aos="fade-up" data-aos-duration="600">We will make absolutely any <span
       class="color-01d0cc">place clean, neat & tidy.</span></h2>
     <p data-aos="fade-up" data-aos-duration="600">Duis aute irure dolor in reprehenderit in voluptate
      velit esse cillum dolore eu fugiat nulla
      pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia des erunt
     ...
     <div class="owl-carousel owl-theme" id="service-slider">
      <div class="item">
       <div class="service-item text-center">
        ...
        <p>Duis aute irure dolor in reprehe
         nderit in voluptate velit esse cillu
         m dolore eu fugiat.</p>
        <a href="services.html"><img src="assets/images/left-angle.png" alt="left-angle"></a>
       </div>
      </div>
      <div class="item">
       <div class="service-item text-center">
   ...
   <div class="team-box">
    <div class="team-box-item text-center position-relative" data-aos="fade-up" data-aos-duration="600">
     ...
     <div class="team-social-icon d-flex flex-column align-items-end">
      <ul class="list-unstyled">
       <li><a href="#" class="d-flex align-items-center justify-content-center"><img
          src="assets/images/facebook-icon.png" alt="facebook-icon"></a></li>
       <li><a href="#" class="d-flex align-items-center justify-content-center"><img
          src="assets/images/twitter-icon.png" alt="twitter-icon"></a></li>
       <li><a href="#" class="d-flex align-items-center justify-content-center"><img
          src="assets/images/linkedin-icon.png" alt="linkedin-icon"></a></li>
       <li><a href="#" class="d-flex align-items-center justify-content-center"><img
          src="assets/images/instagram-icon.png" alt="instagram-icon"></a></li>
      </ul>
     </div>
     <h3>Steve Smith</h3>
    ...
    <div class="row">
     <div class="col-lg-7 col-md-7 order-md-0 order-2">
      <div class="contact-title position-relative">
       <h2 class="text-white" data-aos="fade-up" data-aos-duration="600">Get a free estimate</h2>
      </div>
      <form class="form-con" data-aos="fade-up" data-aos-duration="600" method="post" id="contactpage">
       <ul class="list-unstyled">
        <li>
 ...
 <!-- CONTACT-SECTION -->
 <!-- MAP SECTION -->
 <div class="w-100 float-left map-con position-relative aos-init aos-animate" data-aos="fade-up" data-aos-duration="600">
       ...
       <div class="plan-item text-center">
        ...
        <div class="plan-body">
         <span class="d-block">We are committed to give our
          best services</span>
         <ul class="list-unstyled">
          <li class="position-relative"><img src="assets/images/plan-check.png"
            alt="plan-check"> Bedrroms
           Cleaning</li>
          <li class="position-relative"><img src="assets/images/plan-check.png"
            alt="plan-check"> Vacuming
          </li>
          <li class="position-relative"><img src="assets/images/plan-check.png"
            alt="plan-check"> 2
           Bathroom Cleaning</li>
          <li class="position-relative"><img src="assets/images/plan-check.png"
            alt="plan-check"> Window
           Cleaning</li>
          <li class="position-relative"><img src="assets/images/plan-check.png"
            alt="plan-check"> 1
         ...
         <div class="plan-btn">
          <a href="pricing.html">Select A Plan</a>
         </div>
        </div>
       </div>
      </div>
      <div class="col-lg-4 col-md-4" data-aos="fade-up" data-aos-duration="600">
       <div class="plan-item text-center">
        ...
        <div class="plan-body">
         ...
         <ul class="list-unstyled">
          <li class="position-relative"><img src="assets/images/plan-check.png"
            alt="plan-check"> 3Bedrroms Cleaning</li>
          <li class="position-relative"><img src="assets/images/plan-check.png"
            alt="plan-check"> Vacuming</li>
          <li class="position-relative"><img src="assets/images/plan-check.png"
            alt="plan-check"> 3 Bathroom Cleaning</li>
          <li class="position-relative"><img src="assets/images/plan-check.png"
            alt="plan-check"> Window Cleaning</li>
          <li class="position-relative"><img src="assets/images/plan-check.png"
            alt="plan-check"> 3 Livingroom Cleaning</li>
         </ul>
         <div class="plan-btn">
          <a href="pricing.html">Select A Plan</a>
         </div>
      ...
      <div class="col-lg-4 col-md-4" data-aos="fade-up" data-aos-duration="600">
       <div class="plan-item text-center">
        ...
        <div class="plan-body">
         ...
         <ul class="list-unstyled">
          <li class="position-relative"><img src="assets/images/plan-check.png"
            alt="plan-check"> 4Bedrroms Cleaning</li>
          <li class="position-relative"><img src="assets/images/plan-check.png"
            alt="plan-check"> Vacuming</li>
          <li class="position-relative"><img src="assets/images/plan-check.png"
            alt="plan-check"> 4 Bathroom Cleaning</li>
          <li class="position-relative"><img src="assets/images/plan-check.png"
            alt="plan-check"> Window Cleaning</li>
          <li class="position-relative"><img src="assets/images/plan-check.png"
            alt="plan-check"> 4 Livingroom Cleaning</li>
         </ul>
         <div class="plan-btn">
          <a href="pricing.html">Select A Plan</a>
         </div>
     ...
     <div class="owl-carousel owl-theme" id="client-slider" data-aos="fade-up" data-aos-duration="600">
       ...
       <div class="client-review-box">
        <div class="client-review-content position-relative">
         <p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu
          fugiat nulla pariatur xcepteur sint occaecat cupidatat non proide sunt in culpa
          qui.</p>
         <figure class="mb-0">
        ...
        <div class="client-info">
         <figure class="mb-0">
          <img src="assets/images/client-img1.png" alt="client-img1">
         </figure>
      ...
      <div class="item">
       <div class="client-review-box">
        ...
        <div class="client-info">
         <figure class="mb-0">
          <img src="assets/images/client-img2.png" alt="client-img1">
         </figure>
         <div class="client-name">
          <h4>Nelima Frank</h4>
          <span class="d-block">SEO Manager</span>
      ...
      <div class="item">
       <div class="client-review-box">
        ...
        <div class="client-info">
         <figure class="mb-0">
          <img src="assets/images/client-img3.png" alt="client-img1">
         </figure>
         <div class="client-name">
          <h4>Nelima Frank</h4>
          <span class="d-block">SEO Manager</span>
    ...
    <div class="col-lg-4 col-md-4" data-aos="fade-up" data-aos-duration="600">
     <div class="blog-item">
      ...
      <div class="blog-item-content">
       ...
       <p>Duis aute irure dolor in reprehenderit in volupta te velit esse cillum dolore eu fugiat
        nulla pariat</p>
  ...
  <div class="container">
   <div class="newsletter-box">
    <div class="position-relative newsletter-content">
     <figure class="mb-0">
      <img src="assets/images/paper-plane-icon.png" alt="paper-plane-icon">
     </figure>
   ...
   <div class="footer-box position-relative">
    ...
    <div class="site-map">
     ...
     <div class="online-btn">
      <a href="contact.html">Request With Online Form</a>
     </div>
    </div>
    <div class="site-map">
     <h4>Work Days</h4>
