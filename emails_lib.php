...
class email
{
    protected $siteName = 'Family Anchor';
    protected $siteDomain = 'familyanchorlimited.com';
...
<body width="100%" style="margin: 0; padding: 0 !important; mso-line-height-rule: exactly; background-color: #f5f6fa;">
                        ...
                        <tbody>
                            <tr>
                                <td style="text-align: center; padding-bottom:25px">
                                    <a href="https://familyanchorlimited.com/"><img style="height: 40px" src="https://familyanchorlimited.com/img/logo.png" alt="logo"></a>
                        ...
                        <tbody>
                            <tr>
                                <td style="text-align: center; padding:25px 20px 0;">
                                    <p style="font-size: 13px;">Copyright © ' . $d . ' Family Anchor. All rights reserved.</p>
                                    <ul style="margin: 10px -4px 0;padding: 0;">
                                        <li style="display: inline-block; list-style: none; padding: 4px;"><a style="display: inline-block; height: 30px; width:30px;border-radius: 50%; background-color: #ffffff" href="https://facebook.com/"><img style="width: 30px" src="https://familyanchorlimited.com/mail_images/brand-b.png" alt="brand"></a></li>
                                        <li style="display: inline-block; list-style: none; padding: 4px;"><a style="display: inline-block; height: 30px; width:30px;border-radius: 50%; background-color: #ffffff" href="https://twitter.com/"><img style="width: 30px" src="https://familyanchorlimited.com/mail_images/brand-e.png" alt="brand"></a></li>
                                        <li style="display: inline-block; list-style: none; padding: 4px;"><a style="display: inline-block; height: 30px; width:30px;border-radius: 50%; background-color: #ffffff" href="https://youtube.com/"><img style="width: 30px" src="https://familyanchorlimited.com/mail_images/brand-d.png" alt="brand"></a></li>
                                    </ul>
                                    <p style="padding-top: 15px; font-size: 12px;">For more detail contact us: info@familyanchorlimited.com, support@familyanchorlimited.com</p><p style="padding-top: 15px; font-size: 12px;">This email was sent to you as a registered user of <a style="color: #6576ff; text-decoration:none;" href="https://familyanchorlimited.com/">Family Anchor</a>.</p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
    ...
    public function generalMessage($subjt, $message, $email, $siteName, $siteDomain)
    {
        ...
        $headers .= 'From: Family Anchor <support@familyanchorlimited.com>' . "\r\n";
    ...
    {
        $to  = $emailR;
        $subject = 'You have a new direct sign-up on familyanchorlimited.com';
        $info = 'Dear ' . $nameR . '(' . $usernameR . '), <br><br /> You have a new direct referral sign-up on <br />familyanchorlimited.com<br />User: ' . $usernameM . '<br />Name: ' . $nameM . '<br>E-mail: ' . $emailM . '<br><br >Thank You.';
        $content = $info; //self::generalBody($info);
        $headers = "MIME-Version: 1.0" . "\r\n";
        $headers .= "Content-type:text/html;charset=UTF-8" . "\r\n";
        $headers .= 'From: Family Anchor <support@familyanchorlimited.com>' . "\r\n";
    ...
    {
        $to  = 'info@familyanchorlimited.com';
    ...
    {
        $to  = 'support@familyanchorlimited.com';
        $subject = $subject;
    ...
    public function paymentNotification($amount, $plan, $coin, $id, $name, $email)
    {
        ...
        $header .= 'From: Family Anchor <support@familyanchorlimited.com>' . "\r\n";
...
<body width="100%" style="margin: 0; padding: 0 !important; mso-line-height-rule: exactly; background-color: #f5f6fa;">
    ...
    public function ActivateMail($email, $password, $fullname)
    {
        ...
        <p>Follow this link to verify your account. <a href="https://familyanchorlimited.com/ActivateMail/activate.php?id=' . $email . '&ip=' . $password . '">Verify Account</a> </p>
        <br />
        <p>Best regards, Family Anchor Team<br /><br /> Powered by: <a href="https://familyanchorlimited.com">Family Anchor</a></p>';
        $content = $message; //self::generalBody($message);
        $header = "MIME-Version: 1.0" . "\r\n";
        $header .= "Content-type:text/html;charset=UTF-8" . "\r\n";
        $header .= 'From: Family Anchor <support@familyanchorlimited.com>' . "\r\n";
